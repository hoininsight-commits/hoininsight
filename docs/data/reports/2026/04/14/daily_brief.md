...
Drivers: BTCUSD:FLAT(0.00)[png](data/reports/2026/04/14/charts/crypto_btc_usd_spot_coingecko.png) | WTI:FLAT(0.00)[png](data/reports/2026/04/14/charts/comm_wti_fred.png)
Meta topics: [json](data/meta_topics/2026/04/14/meta_topics.json)
This regime has persisted for 83 consecutive days since 2026-01-14.

Historical context:
- (no meta regime detected) appeared 1 times historically
- Average persistence: 83.0 days (max 83 days)
...
|---:|---|---|---:|---:|---:|---|---:|---|---|---|---|
| 1 | BTCUSD | data/features/anomalies/2026/04/14/crypto_btc_usd_spot_coingecko.json L2 Signal | 6.00 | 2 | 6.00 | FLAT (0.00) | **6.00** | HIGH | [png](data/reports/2026/04/14/charts/crypto_btc_usd_spot_coingecko.png) | [json](data/topics/2026/04/14/crypto_btc_usd_spot_coingecko.json) | [json](data/features/anomalies/2026/04/14/crypto_btc_usd_spot_coingecko.json) |
...
- [HIGH] GS_RATIO: data/features/anomalies/2026/04/14/derived_gold_silver_ratio.json L2 Signal (score=6.00) | Mom: FLAT (slope=0.00) | App7d=2
- [HIGH] M_AND_A_CB: data/features/anomalies/2026/04/14/struct_dart_cb_bw.json L2 Signal (score=6.00) | Mom: FLAT (slope=0.00) | App7d=7
- [HIGH] M_AND_A_DISP: data/features/anomalies/2026/04/14/struct_dart_disposal.json L2 Signal (score=6.00) | Mom: FLAT (slope=0.00) | App7d=7
- [MED] US10Y: data/features/anomalies/2026/04/14/rates_us10y_fred.json L1 Signal (score=3.00) | Mom: DOWN (slope=-0.50) | App7d=7
...
- [LOW] KOSPI: data/features/anomalies/2026/04/14/index_kospi_stooq.json (Normal) (score=0.00) | Mom: FLAT (slope=0.00) | App7d=7
- [LOW] US02Y: data/features/anomalies/2026/04/14/rates_us02y_fred.json (Normal) (score=0.00) | Mom: FLAT (slope=0.00) | App7d=7
- [LOW] GOLD: data/features/anomalies/2026/04/14/metal_gold_paxg_coingecko.json (Normal) (score=0.00) | Mom: FLAT (slope=0.00) | App7d=7
- [LOW] KOR_RATE: data/features/anomalies/2026/04/14/rates_kor_base_rate_ecos.json (Normal) (score=0.00) | Mom: FLAT (slope=0.00) | App7d=7
- [LOW] FED_FUNDS: data/features/anomalies/2026/04/14/rates_fed_funds_fred.json (Normal) (score=0.00) | Mom: FLAT (slope=0.00) | App7d=7
- [LOW] UNRATE: data/features/anomalies/2026/04/14/employment_unrate_fred.json (Normal) (score=0.00) | Mom: FLAT (slope=0.00) | App7d=7
- [LOW] FIN_STRESS: data/features/anomalies/2026/04/14/risk_financial_stress_fred.json (Normal) (score=0.00) | Mom: FLAT (slope=0.00) | App7d=7
- [LOW] YIELD_CURVE: data/features/anomalies/2026/04/14/derived_yield_curve_10y_2y.json (Normal) (score=0.00) | Mom: FLAT (slope=0.00) | App7d=7

- See: `data/reports/2026/04/14/data_snapshot.md`
