...
Drivers: VIX:UP(0.50)[png](data/reports/2026/04/12/charts/risk_vix_fred.png) | WTI:FLAT(0.00)[png](data/reports/2026/04/12/charts/comm_wti_fred.png)
Meta topics: [json](data/meta_topics/2026/04/12/meta_topics.json)
This regime has persisted for 81 consecutive days since 2026-01-14.

Historical context:
- (no meta regime detected) appeared 1 times historically
- Average persistence: 81.0 days (max 81 days)
...
- [HIGH] HY_SPREAD: data/features/anomalies/2026/04/12/credit_hy_spread_fred.json L2 Signal (score=6.00) | Mom: UP (slope=1.00) | App7d=4
- [HIGH] M_AND_A_CB: data/features/anomalies/2026/04/12/struct_dart_cb_bw.json L2 Signal (score=6.00) | Mom: FLAT (slope=0.00) | App7d=7
- [HIGH] M_AND_A_DISP: data/features/anomalies/2026/04/12/struct_dart_disposal.json L2 Signal (score=6.00) | Mom: FLAT (slope=0.00) | App7d=7
- [MED] BTCUSD: data/features/anomalies/2026/04/12/crypto_btc_usd_spot_coingecko.json L1 Signal (score=3.00) | Mom: DOWN (slope=-3.00) | App7d=2
- [MED] US10Y: data/features/anomalies/2026/04/12/rates_us10y_fred.json L1 Signal (score=3.00) | Mom: FLAT (slope=0.00) | App7d=7
- [MED] SPX: data/features/anomalies/2026/04/12/index_spx_fred.json L1 Signal (score=3.00) | Mom: FLAT (slope=0.00) | App7d=4
