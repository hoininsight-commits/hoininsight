...
- started_utc: 2026-01-25T14:15:26Z
- finished_utc: 2026-01-25T14:15:59Z
- status: SUCCESS
...
anomaly: ok
anchor_engine: ok
snapshot: ok (data/reports/2026/01/25/data_snapshot.md)
topic_gate: ok
decision: ok
report: ok | data/reports/2026/01/25/daily_brief.md
checks:
[SKIP] outputs(crypto_btc_usd_spot_coingecko) missing
[SKIP] outputs(rates_us10y_fred) missing
[SKIP] outputs(risk_vix_fred) missing
[SKIP] outputs(index_spx_fred) missing
[SKIP] outputs(index_kospi_stooq) missing
[SKIP] outputs(index_nasdaq_fred) missing
[SKIP] outputs(fx_dxy_index_stooq) missing
[SKIP] outputs(rates_us02y_fred) missing
[SKIP] outputs(comm_wti_fred) missing
[SKIP] outputs(metal_platinum_xptusd_stooq) missing
[SKIP] outputs(metal_gold_paxg_coingecko) missing
[SKIP] outputs(metal_silver_kag_coingecko) missing
[SKIP] outputs(metal_silver_kag_coingecko) missing
[SKIP] outputs(crypto_eth_usd_spot_coingecko) missing
[SKIP] outputs(rates_kor_base_rate_ecos) missing
[SKIP] outputs(inflation_kor_cpi_ecos) missing
[SKIP] outputs(fx_usdkrw_ecos) missing
[SKIP] outputs(rates_fed_funds_fred) missing
[SKIP] outputs(inflation_cpi_fred) missing
[SKIP] outputs(inflation_pce_fred) missing
[SKIP] outputs(liquidity_m2_fred) missing
[SKIP] outputs(employment_unrate_fred) missing
[SKIP] outputs(credit_hy_spread_fred) missing
[SKIP] outputs(risk_financial_stress_fred) missing
[SKIP] outputs(derived_yield_curve_10y_2y) missing
[SKIP] outputs(derived_gold_silver_ratio) missing
[SKIP] outputs(struct_dart_cb_bw) missing
[SKIP] outputs(struct_dart_disposal) missing
...
engine: done
health: data/reports/2026/01/25/health.json
```
