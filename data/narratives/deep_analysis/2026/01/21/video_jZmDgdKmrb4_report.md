...
* **Level**: L2
* **Reasoning**: Supply/Demand imbalance signals. L3 Keyword '강제' found
...
## 7️⃣ 엔진 최종 판정 요약
> 엔진은 '가격'와(과) 관련하여 L2 수준의 이상징후를 감지했습니다. No explicit immediate trigger found, likely a trend analysis.
