...
* **Real Topic**: 가격
* **Reframed**: KB Keyword Match: '가격' (mentioned 4 times)

## 3️⃣ 이상징후 레벨 판정 (ANOMALY LEVEL)
* **Level**: L3
* **Reasoning**: High structural impact detected. L3 Keyword '구조' found, L3 Keyword '강제' found, L2 Keyword '부족' found
...
## 7️⃣ 엔진 최종 판정 요약
> 엔진은 '가격'와(과) 관련하여 L3 수준의 이상징후를 감지했습니다. No explicit immediate trigger found, likely a trend analysis.
