...
- Average persistence: 23.0 days (max 23 days)
...
- [MED] KOSPI: data/features/anomalies/2026/02/06/index_kospi_stooq.json L1 Signal (base=3.00, final_m=4.73) | Mom: DOWN (slope=-0.75) -> x0.9 | App7d=5
...
- [LOW] NASDAQ: data/features/anomalies/2026/02/06/index_nasdaq_fred.json (Normal) (base=0.00, final_m=0.00) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=6
- [LOW] US02Y: data/features/anomalies/2026/02/06/rates_us02y_fred.json (Normal) (base=0.00, final_m=0.00) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=7
- [LOW] WTI: data/features/anomalies/2026/02/06/comm_wti_fred.json (Normal) (base=0.00, final_m=0.00) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=7
- [LOW] GOLD: data/features/anomalies/2026/02/06/metal_gold_paxg_coingecko.json (Normal) (base=0.00, final_m=0.00) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=7
- [LOW] KOR_RATE: data/features/anomalies/2026/02/06/rates_kor_base_rate_ecos.json (Normal) (base=0.00, final_m=0.00) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=7
- [LOW] USDKRW_ECOS: data/features/anomalies/2026/02/06/fx_usdkrw_ecos.json (Normal) (base=0.00, final_m=0.00) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=5
- [LOW] UNRATE: data/features/anomalies/2026/02/06/employment_unrate_fred.json (Normal) (base=0.00, final_m=0.00) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=7
- [LOW] FIN_STRESS: data/features/anomalies/2026/02/06/risk_financial_stress_fred.json (Normal) (base=0.00, final_m=0.00) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=7

- See: `data/reports/2026/02/06/data_snapshot.md`
