...
- Average persistence: 36.0 days (max 36 days)
...
- [HIGH] M2_USA: data/features/anomalies/2026/02/19/liquidity_m2_fred.json L2 Signal (base=6.00, final_m=12.30) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=7
- [HIGH] M_AND_A_CB: data/features/anomalies/2026/02/19/struct_dart_cb_bw.json L2 Signal (base=6.00, final_m=12.30) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=7
- [HIGH] M_AND_A_DISP: data/features/anomalies/2026/02/19/struct_dart_disposal.json L2 Signal (base=6.00, final_m=12.30) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=7
...
- [LOW] NASDAQ: data/features/anomalies/2026/02/19/index_nasdaq_fred.json (Normal) (base=0.00, final_m=0.00) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=7
- [LOW] WTI: data/features/anomalies/2026/02/19/comm_wti_fred.json (Normal) (base=0.00, final_m=0.00) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=7
- [LOW] GOLD: data/features/anomalies/2026/02/19/metal_gold_paxg_coingecko.json (Normal) (base=0.00, final_m=0.00) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=7
- [LOW] SILVER: data/features/anomalies/2026/02/19/metal_silver_kag_coingecko.json (Normal) (base=0.00, final_m=0.00) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=5
- [LOW] SILVER: data/features/anomalies/2026/02/19/metal_silver_kag_coingecko.json (Normal) (base=0.00, final_m=0.00) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=5
- [LOW] ETHUSD: data/features/anomalies/2026/02/19/crypto_eth_usd_spot_coingecko.json (Normal) (base=0.00, final_m=0.00) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=5
- [LOW] KOR_RATE: data/features/anomalies/2026/02/19/rates_kor_base_rate_ecos.json (Normal) (base=0.00, final_m=0.00) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=7
- [LOW] USDKRW_ECOS: data/features/anomalies/2026/02/19/fx_usdkrw_ecos.json (Normal) (base=0.00, final_m=0.00) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=7
- [LOW] UNRATE: data/features/anomalies/2026/02/19/employment_unrate_fred.json (Normal) (base=0.00, final_m=0.00) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=7
- [LOW] HY_SPREAD: data/features/anomalies/2026/02/19/credit_hy_spread_fred.json (Normal) (base=0.00, final_m=0.00) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=7
- [LOW] FIN_STRESS: data/features/anomalies/2026/02/19/risk_financial_stress_fred.json (Normal) (base=0.00, final_m=0.00) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=7
- [LOW] GS_RATIO: data/features/anomalies/2026/02/19/derived_gold_silver_ratio.json (Normal) (base=0.00, final_m=0.00) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=5

- See: `data/reports/2026/02/19/data_snapshot.md`
...
- **Rationale:** 현재 시장은 [Monetary Tightening] 국면에 진입한 것으로 분석됩니다. 지표에서 Percentile 4.8% (Extreme). 특히 동일 섹터인 [rates_us10y_fred] 등에서도 동시다발적으로 이상 신호가 감지되어 해당 테마의 신뢰도가 매우 높습니다.
