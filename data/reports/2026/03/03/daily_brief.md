...
- Average persistence: 48.0 days (max 48 days)
...
- [MED] USDKRW_ECOS: data/features/anomalies/2026/03/03/fx_usdkrw_ecos.json L1 Signal (score=3.00) | Mom: FLAT (slope=0.00) | App7d=5
...
- [LOW] US10Y: data/features/anomalies/2026/03/03/rates_us10y_fred.json (Normal) (score=0.00) | Mom: FLAT (slope=0.00) | App7d=6
- [LOW] VIX: data/features/anomalies/2026/03/03/risk_vix_fred.json (Normal) (score=0.00) | Mom: FLAT (slope=0.00) | App7d=5
...
- [LOW] SILVER: data/features/anomalies/2026/03/03/metal_silver_kag_coingecko.json (Normal) (score=0.00) | Mom: FLAT (slope=0.00) | App7d=7
- [LOW] ETHUSD: data/features/anomalies/2026/03/03/crypto_eth_usd_spot_coingecko.json (Normal) (score=0.00) | Mom: FLAT (slope=0.00) | App7d=7
- [LOW] KOR_RATE: data/features/anomalies/2026/03/03/rates_kor_base_rate_ecos.json (Normal) (score=0.00) | Mom: FLAT (slope=0.00) | App7d=7
- [LOW] UNRATE: data/features/anomalies/2026/03/03/employment_unrate_fred.json (Normal) (score=0.00) | Mom: FLAT (slope=0.00) | App7d=7
- [LOW] HY_SPREAD: data/features/anomalies/2026/03/03/credit_hy_spread_fred.json (Normal) (score=0.00) | Mom: FLAT (slope=0.00) | App7d=6
- [LOW] FIN_STRESS: data/features/anomalies/2026/03/03/risk_financial_stress_fred.json (Normal) (score=0.00) | Mom: FLAT (slope=0.00) | App7d=7
- [LOW] YIELD_CURVE: data/features/anomalies/2026/03/03/derived_yield_curve_10y_2y.json (Normal) (score=0.00) | Mom: FLAT (slope=0.00) | App7d=6
- [LOW] GS_RATIO: data/features/anomalies/2026/03/03/derived_gold_silver_ratio.json (Normal) (score=0.00) | Mom: FLAT (slope=0.00) | App7d=7

- See: `data/reports/2026/03/03/data_snapshot.md`
