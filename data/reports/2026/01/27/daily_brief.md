...
Drivers: CPI_USA:FLAT(0.00)[png](data/reports/2026/01/27/charts/inflation_cpi_fred.png) | PCE_USA:FLAT(0.00)[png](data/reports/2026/01/27/charts/inflation_pce_fred.png)
...
- [MED] SILVER: data/features/anomalies/2026/01/27/metal_silver_kag_coingecko.json L1 Signal (base=3.00, final_m=5.70) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=6
- [MED] SILVER: data/features/anomalies/2026/01/27/metal_silver_kag_coingecko.json L1 Signal (base=3.00, final_m=5.70) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=6
...
- [LOW] GOLD: data/features/anomalies/2026/01/27/metal_gold_paxg_coingecko.json (Normal) (base=0.00, final_m=0.00) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=1
...
- **Topic:** [Risk-Off Wave] 감지된 토픽: derived_gold_silver_ratio L2 Signal 중심의 시장 발작 (골드(Gold) 가격 이상 변동, metal_silver_kag_coingecko 동반)
- **Rationale:** 현재 시장은 [Risk-Off Wave] 국면에 진입한 것으로 분석됩니다. 지표에서 Z-Score -2.43 >= 2.0. 특히 동일 섹터인 [metal_gold_paxg_coingecko] 등에서도 동시다발적으로 이상 신호가 감지되어 해당 테마의 신뢰도가 매우 높습니다.
