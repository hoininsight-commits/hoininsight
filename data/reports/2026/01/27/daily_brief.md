...
Drivers: SILVER:UP(0.60)[png](data/reports/2026/01/27/charts/metal_silver_kag_coingecko.png) | SILVER:UP(0.60)[png](data/reports/2026/01/27/charts/metal_silver_kag_coingecko.png)
Meta topics: [json](data/meta_topics/2026/01/27/meta_topics.json)
This regime has persisted for 13 consecutive days since 2026-01-14.

Historical context:
- (no meta regime detected) appeared 1 times historically
- Average persistence: 13.0 days (max 13 days)
...
|---:|---|---|---:|---:|---:|---|---:|---|---|---|---|
| 1 | SILVER | data/features/anomalies/2026/01/27/metal_silver_kag_coingecko.json L2 Signal | 6.00 | 6 (x1.90) | 11.40 | UP (0.60) | **12.54** | HIGH | [png](data/reports/2026/01/27/charts/metal_silver_kag_coingecko.png) | [json](data/topics/2026/01/27/metal_silver_kag_coingecko.json) | [json](data/features/anomalies/2026/01/27/metal_silver_kag_coingecko.json) |
| 2 | SILVER | data/features/anomalies/2026/01/27/metal_silver_kag_coingecko.json L2 Signal | 6.00 | 6 (x1.90) | 11.40 | UP (0.60) | **12.54** | HIGH | [png](data/reports/2026/01/27/charts/metal_silver_kag_coingecko.png) | [json](data/topics/2026/01/27/metal_silver_kag_coingecko.json) | [json](data/features/anomalies/2026/01/27/metal_silver_kag_coingecko.json) |
| 3 | CPI_USA | data/features/anomalies/2026/01/27/inflation_cpi_fred.json L2 Signal | 6.00 | 6 (x1.90) | 11.40 | FLAT (0.00) | **11.40** | HIGH | [png](data/reports/2026/01/27/charts/inflation_cpi_fred.png) | [json](data/topics/2026/01/27/inflation_cpi_fred.json) | [json](data/features/anomalies/2026/01/27/inflation_cpi_fred.json) |
| 4 | PCE_USA | data/features/anomalies/2026/01/27/inflation_pce_fred.json L2 Signal | 6.00 | 6 (x1.90) | 11.40 | FLAT (0.00) | **11.40** | HIGH | [png](data/reports/2026/01/27/charts/inflation_pce_fred.png) | [json](data/topics/2026/01/27/inflation_pce_fred.json) | [json](data/features/anomalies/2026/01/27/inflation_pce_fred.json) |
| 5 | M2_USA | data/features/anomalies/2026/01/27/liquidity_m2_fred.json L2 Signal | 6.00 | 6 (x1.90) | 11.40 | FLAT (0.00) | **11.40** | HIGH | [png](data/reports/2026/01/27/charts/liquidity_m2_fred.png) | [json](data/topics/2026/01/27/liquidity_m2_fred.json) | [json](data/features/anomalies/2026/01/27/liquidity_m2_fred.json) |

## Per-dataset Topics
- [HIGH] SILVER: data/features/anomalies/2026/01/27/metal_silver_kag_coingecko.json L2 Signal (base=6.00, final_m=12.54) | Mom: UP (slope=0.60) -> x1.1 | App7d=6
- [HIGH] SILVER: data/features/anomalies/2026/01/27/metal_silver_kag_coingecko.json L2 Signal (base=6.00, final_m=12.54) | Mom: UP (slope=0.60) -> x1.1 | App7d=6
...
- [LOW] USDKRW_ECOS: data/features/anomalies/2026/01/27/fx_usdkrw_ecos.json (Normal) (base=0.00, final_m=0.00) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=4
- [LOW] UNRATE: data/features/anomalies/2026/01/27/employment_unrate_fred.json (Normal) (base=0.00, final_m=0.00) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=6
- [LOW] FIN_STRESS: data/features/anomalies/2026/01/27/risk_financial_stress_fred.json (Normal) (base=0.00, final_m=0.00) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=6
- [LOW] YIELD_CURVE: data/features/anomalies/2026/01/27/derived_yield_curve_10y_2y.json (Normal) (base=0.00, final_m=0.00) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=3

- See: `data/reports/2026/01/27/data_snapshot.md`
...
- **Rationale:** 현재 시장은 [Risk-Off Wave] 국면에 진입한 것으로 분석됩니다. 지표가 평소 변동폭 대비 2.05배(표준편차) 이상 유의미한 변화을(를) 보였습니다. 특히 동일 섹터인 [metal_gold_paxg_coingecko] 등에서도 동시다발적으로 이상 신호가 감지되어 해당 테마의 신뢰도가 매우 높습니다.
