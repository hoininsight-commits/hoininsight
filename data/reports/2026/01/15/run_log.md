...
- started_utc: 2026-01-15T07:01:09Z
- finished_utc: 2026-01-15T07:01:23Z
- status: SUCCESS
...
[SKIP] outputs(rates_us10y_yield_ustreasury) missing
[SKIP] outputs(risk_vix_index_stooq) missing
[SKIP] outputs(index_spx_sp500_stooq) missing
...
schema_checks:
[SKIP] schema(crypto_btc_usd_spot_coingecko): missing curated file (soft_fail)
...
[SKIP] schema(rates_us10y_yield_ustreasury): missing curated file (soft_fail)
[SKIP] schema(risk_vix_index_stooq): missing curated file (soft_fail)
[SKIP] schema(index_spx_sp500_stooq): missing curated file (soft_fail)
[SKIP] schema(index_kospi_stooq): missing curated file (soft_fail)
...
engine: done
health: data/reports/2026/01/15/health.json
```
