...
Drivers: NASDAQ:UP(0.75)[png](data/reports/2026/01/30/charts/index_nasdaq_fred.png) | CPI_USA:FLAT(0.00)[png](data/reports/2026/01/30/charts/inflation_cpi_fred.png)
Meta topics: [json](data/meta_topics/2026/01/30/meta_topics.json)
This regime has persisted for 16 consecutive days since 2026-01-14.

Historical context:
- (no meta regime detected) appeared 1 times historically
- Average persistence: 16.0 days (max 16 days)
...
|---:|---|---|---:|---:|---:|---|---:|---|---|---|---|
| 1 | NASDAQ | data/features/anomalies/2026/01/30/index_nasdaq_fred.json L2 Signal | 6.00 | 5 (x1.75) | 10.50 | UP (0.75) | **11.55** | HIGH | [png](data/reports/2026/01/30/charts/index_nasdaq_fred.png) | [json](data/topics/2026/01/30/index_nasdaq_fred.json) | [json](data/features/anomalies/2026/01/30/index_nasdaq_fred.json) |
| 2 | CPI_USA | data/features/anomalies/2026/01/30/inflation_cpi_fred.json L2 Signal | 6.00 | 6 (x1.90) | 11.40 | FLAT (0.00) | **11.40** | HIGH | [png](data/reports/2026/01/30/charts/inflation_cpi_fred.png) | [json](data/topics/2026/01/30/inflation_cpi_fred.json) | [json](data/features/anomalies/2026/01/30/inflation_cpi_fred.json) |
| 3 | PCE_USA | data/features/anomalies/2026/01/30/inflation_pce_fred.json L2 Signal | 6.00 | 6 (x1.90) | 11.40 | FLAT (0.00) | **11.40** | HIGH | [png](data/reports/2026/01/30/charts/inflation_pce_fred.png) | [json](data/topics/2026/01/30/inflation_pce_fred.json) | [json](data/features/anomalies/2026/01/30/inflation_pce_fred.json) |
| 4 | M2_USA | data/features/anomalies/2026/01/30/liquidity_m2_fred.json L2 Signal | 6.00 | 6 (x1.90) | 11.40 | FLAT (0.00) | **11.40** | HIGH | [png](data/reports/2026/01/30/charts/liquidity_m2_fred.png) | [json](data/topics/2026/01/30/liquidity_m2_fred.json) | [json](data/features/anomalies/2026/01/30/liquidity_m2_fred.json) |
| 5 | GS_RATIO | data/features/anomalies/2026/01/30/derived_gold_silver_ratio.json L2 Signal | 6.00 | 6 (x1.90) | 11.40 | FLAT (0.00) | **11.40** | HIGH | [png](data/reports/2026/01/30/charts/derived_gold_silver_ratio.png) | [json](data/topics/2026/01/30/derived_gold_silver_ratio.json) | [json](data/features/anomalies/2026/01/30/derived_gold_silver_ratio.json) |

## Per-dataset Topics
- [HIGH] NASDAQ: data/features/anomalies/2026/01/30/index_nasdaq_fred.json L2 Signal (base=6.00, final_m=11.55) | Mom: UP (slope=0.75) -> x1.1 | App7d=5
- [HIGH] CPI_USA: data/features/anomalies/2026/01/30/inflation_cpi_fred.json L2 Signal (base=6.00, final_m=11.40) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=6
- [HIGH] PCE_USA: data/features/anomalies/2026/01/30/inflation_pce_fred.json L2 Signal (base=6.00, final_m=11.40) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=6
- [HIGH] M2_USA: data/features/anomalies/2026/01/30/liquidity_m2_fred.json L2 Signal (base=6.00, final_m=11.40) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=6
- [HIGH] GS_RATIO: data/features/anomalies/2026/01/30/derived_gold_silver_ratio.json L2 Signal (base=6.00, final_m=11.40) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=6
- [HIGH] M_AND_A_CB: data/features/anomalies/2026/01/30/struct_dart_cb_bw.json L2 Signal (base=6.00, final_m=11.40) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=6
...
- [HIGH] BTCUSD: data/features/anomalies/2026/01/30/crypto_btc_usd_spot_coingecko.json L2 Signal (base=6.00, final_m=10.50) | Mom: FLAT (slope=0.00) -> x1.0 | App7d=5
...
- See: `data/reports/2026/01/30/data_snapshot.md`
