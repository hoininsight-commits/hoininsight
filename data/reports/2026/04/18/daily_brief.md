...
- Average persistence: 87.0 days (max 87 days)
...
| 3 | NASDAQ | data/features/anomalies/2026/04/18/index_nasdaq_fred.json L2 Signal | 6.00 | 7 | 6.00 | UP (0.50) | **6.00** | HIGH | [png](data/reports/2026/04/18/charts/index_nasdaq_fred.png) | [json](data/topics/2026/04/18/index_nasdaq_fred.json) | [json](data/features/anomalies/2026/04/18/index_nasdaq_fred.json) |
| 4 | WTI | data/features/anomalies/2026/04/18/comm_wti_fred.json L2 Signal | 6.00 | 7 | 6.00 | FLAT (0.00) | **6.00** | HIGH | [png](data/reports/2026/04/18/charts/comm_wti_fred.png) | [json](data/topics/2026/04/18/comm_wti_fred.json) | [json](data/features/anomalies/2026/04/18/comm_wti_fred.json) |
| 5 | CPI_USA | data/features/anomalies/2026/04/18/inflation_cpi_fred.json L2 Signal | 6.00 | 7 | 6.00 | FLAT (0.00) | **6.00** | HIGH | [png](data/reports/2026/04/18/charts/inflation_cpi_fred.png) | [json](data/topics/2026/04/18/inflation_cpi_fred.json) | [json](data/features/anomalies/2026/04/18/inflation_cpi_fred.json) |
...
- [HIGH] WTI: data/features/anomalies/2026/04/18/comm_wti_fred.json L2 Signal (score=6.00) | Mom: FLAT (slope=0.00) | App7d=7
- [HIGH] CPI_USA: data/features/anomalies/2026/04/18/inflation_cpi_fred.json L2 Signal (score=6.00) | Mom: FLAT (slope=0.00) | App7d=7
- [HIGH] PCE_USA: data/features/anomalies/2026/04/18/inflation_pce_fred.json L2 Signal (score=6.00) | Mom: FLAT (slope=0.00) | App7d=7
- [HIGH] M2_USA: data/features/anomalies/2026/04/18/liquidity_m2_fred.json L2 Signal (score=6.00) | Mom: FLAT (slope=0.00) | App7d=7
...
- [MED] KOSPI: data/features/anomalies/2026/04/18/index_kospi_stooq.json L1 Signal (score=3.00) | Mom: DOWN (slope=-3.00) | App7d=2
...
- [LOW] VIX: data/features/anomalies/2026/04/18/risk_vix_fred.json (Normal) (score=0.00) | Mom: FLAT (slope=0.00) | App7d=2
...
- [LOW] SILVER: data/features/anomalies/2026/04/18/metal_silver_kag_coingecko.json (Normal) (score=0.00) | Mom: FLAT (slope=0.00) | App7d=3
- [LOW] SILVER: data/features/anomalies/2026/04/18/metal_silver_kag_coingecko.json (Normal) (score=0.00) | Mom: FLAT (slope=0.00) | App7d=3
...
- [LOW] HY_SPREAD: data/features/anomalies/2026/04/18/credit_hy_spread_fred.json (Normal) (score=0.00) | Mom: FLAT (slope=0.00) | App7d=4
- [LOW] FIN_STRESS: data/features/anomalies/2026/04/18/risk_financial_stress_fred.json (Normal) (score=0.00) | Mom: FLAT (slope=0.00) | App7d=7
- [LOW] YIELD_CURVE: data/features/anomalies/2026/04/18/derived_yield_curve_10y_2y.json (Normal) (score=0.00) | Mom: FLAT (slope=0.00) | App7d=7
- [LOW] GS_RATIO: data/features/anomalies/2026/04/18/derived_gold_silver_ratio.json (Normal) (score=0.00) | Mom: FLAT (slope=0.00) | App7d=3

- See: `data/reports/2026/04/18/data_snapshot.md`
...
- **Rationale:** Anchor Logic: Statistical Deviation Z=2.07 (No Cluster) (Gap Status: Insufficient Evidence for L3/L4)
