...
- **사모펀드(PEF) Exit 압력 (만기 임박/보유 기간 5년 이상)**
- **블록딜(시간외 대량매매) 체결 및 그 이후 주가 안정**
- **대주주/특수관계인 지분 담보 변화**

**단계 (Refined for Pre-M&A):**
- **S-L1 Structural Signal**: 
    - 구조적 이벤트의 단순 일정 도래 (락업 해제일, 펀드 만기 등)
    - 아직 가격 반응 없음.
- **S-L2 Structural Anticipation**: 
    - 이벤트 전후 **비정상 거래대금/RS 상승** 동반.
    - 블록딜 루머나 지분 경쟁 가능성 대두.
- **S-L3 Structural Reconfiguration**: 
    - **구조 재편 가시화**. 블록딜 완료 후 반등, 전략적 매수자(SK, 한화 등) 등장.
    - 실제 기업 가치와 시총 간 괴리가 자본 논리로 설명되기 시작함.
