...
def raw_path_for_today(base_dir: Path) -> Path:
    ...
    return base_dir / "data" / "raw" / "index_kospi_stooq" / y / m / d / "kospi.json"

def write_curated_kospi_csv(base_dir: Path) -> Path:
    ...
    out_path = base_dir / "data" / "curated" / "indices" / "kospi.csv"
