...
def raw_path_for_today(base_dir: Path) -> Path:
    ...
    return base_dir / "data" / "raw" / "metal_silver_xagusd_spot_yfinance" / y / m / d / "xag_usd.json"

def write_curated_xag_csv(base_dir: Path) -> Path:
    ...
    out_path = base_dir / "data" / "curated" / "metals" / "silver_usd.csv"
