...
def call_gemini_with_control(client, prompt: str, agent: str = "UNKNOWN", tier: int = 3, max_tokens: int = 8192, model: str = None, system_prompt: str = None):
    ...
    for attempt in range(max_retries + 1):
        ...
        try:
            ...
            data = client.call_json(current_prompt, max_tokens=limit, model=model, system_prompt=system_prompt)
