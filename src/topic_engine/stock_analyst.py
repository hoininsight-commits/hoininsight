...
[STRATEGIST TASK]
1. **Industrial Bottleneck (산업의 급소)**: 이 사건으로 인해 전 세계적으로 가장 부족해질 '무엇'은 무엇인가? 그 병목(Bottleneck)을 쥐고 있는 기업을 찾아라.
2. **Second-order Effect (2차 파급 효과)**: 뉴스에 직접 언급된 뻔한 종목(1차)이 아니라, 그 사건의 여파로 인해 '결국 돈을 벌 수밖에 없는' 배후의 전략주(2차)를 선정하라.
3. **Revenue Linkage (수익적 필연성)**: 해당 이슈가 기업의 **매출(Top-line)**이나 **이익률(Margin)**에 어떻게 꽂히는지 산업적/재무적 근거를 제시하라. 특히 '독점적 지위'나 '대체 불가능성'을 증명하라.
4. **Hunter's Verdict (사냥꾼의 판결)**: 대중의 공포나 환희 뒤에 숨겨진 자본의 냉혹한 이동 경로를 단호한 어조로 분석하라.

[OUTPUT JSON FORMAT]
{{
  "bottleneck": "현재 가장 심각해질 병목 지점 정의",
  "sectors": [
    {{
      "name": "섹터명",
      "strategic_reason": "현상 뒤에 숨겨진 산업적 기회 및 필연성 분석",
      "stocks": [
        {{
          "name": "종목명",
          "type": "1차 수혜주 또는 2차 전략주",
          "linkage": "이슈와 실적 사이의 끊을 수 없는 연결 고리 (예: 정부 예산 집행 시 독점 수혜 구조 등)",
          "moat": "이 기업이 이 이슈에서 대체 불가능한 이유"
        }}
      ]
    }}
  ],
