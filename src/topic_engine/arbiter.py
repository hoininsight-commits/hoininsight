...
45: [사냥꾼의 토픽 선정 원칙]
46: 1. **[CRITICAL] Today Only**: 오늘(**{today_str} {weekday_str}**) 발생한 사건에 압도적인 가중치를 두십시오. 과거 뉴스는 이미 시장에 반영된 '죽은 고기'입니다.
47: 2. **Global Alpha & Adrenaline**: 국내 지엽적 뉴스보다 **글로벌 반도체(AI), 금리, 빅테크** 등 시장 전체의 아드레날린을 깨울 수 있는 '큰 판'의 뉴스를 우선하십시오.
48: 3. **Killer Numbers**: "많이 올랐다"는 서술보다 **"1000% 폭등", "2조 순매수"** 등 압도적인 수치 데이터가 포함된 토픽을 '급소'로 간주하십시오.
49: 4. **Bottleneck & Regime**: 단순한 등락이 아니라, 공급망의 병목, 정책의 거대한 전환, 체제의 붕괴 등 '판이 바뀌는' 뉴스를 사냥하십시오.
50: 5. **Account Impact**: 시청자의 계좌를 실질적으로 녹이거나 불릴 수 있는 '돈 냄새' 나는 토픽이어야 합니다.
